...
class GadgetifyWithGSBlr
{
    ...
    void catalog()
    {
      ...
      cout<<"Name: Basshead Earphones, Original Price: Rs. 1200, Discount price: Rs. 899, Weight: 150g"<<endl ; 
	  cout<<"Name: Bluetooth Computer Mouse, Original Price: Rs. 600, Discount price: Rs. 499, Weight: 120g"<<endl; 
...
int main()
{
    ...
    // convert now to string form
      ...
      for(i=0;i<n;i++)
      {
         cout<<"Your selected item: "<<e1[i].s_no<<"\t";
